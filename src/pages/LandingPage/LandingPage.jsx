...
const LandingPage = () => {
    return (
        ...
        //         </div>
        //         <div className="image">
        //             <img src="images/homegraphic1.webp" alt="" />
        //         </div>
        //     </section>
        ...
        //             <div className="box">
        //                 <h3>Quick Links</h3>
        //                 <a href="#home" className="links"> < i className="fas fa-arrow-right" /> Home </a>
        //                 <a href="#features" className="links"> <i className="fas fa-arrow-right" /> Features </a>
        //                 <a href="#contact" className="links"> <i className="fas fa-arrow-right" /> Our Team </a>
        //             </div>
                                            ...
                                            <g className="anime-element fadeleft-animation">
                                                <g transform="translate(56 157)">
                                                    ...
                                                    <g transform="translate(28 232)">
                                                        ...
                                                        <use
                                                            fill="#ABABC9"
                                                            // xlink:href="#hero-illustration-k"
                                                        />
                                                        <image
                                ...
                                <div className="feature text-center is-revealing">
                                    <div className="feature-inner">
                                        ...
                                        <p className="text-sm">
                                            ...
                                            place of English to emphasise design
                                            elements.
                                        </p>
                                    </div>
                                </div>
